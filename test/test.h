...
class EmbeddingGenerator : public ssht::IDataReader {
public:
	...
	ssht::Record read(bool) override {
		m_current++;
...
class VariedValueGenerator : public ssht::IDataReader {
public:
...
class FakeWriter : public ssht::IDataWriter {
public:
